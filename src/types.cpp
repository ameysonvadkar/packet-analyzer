...
// NOTE: Specific sub-brands (YouTube, Instagram, WhatsApp) MUST be checked
// BEFORE their parent platforms (Google, Facebook/Meta) to avoid misclassification.
AppType sniToAppType(const std::string& sni) {
    ...
    // ---- YouTube (check BEFORE Google, since YouTube CDNs share Google domains) ----
